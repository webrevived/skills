...
| ----- | -------- | ------------ | ------ |
| [codex-loop](./skills/engineering/codex-loop/SKILL.md) | Engineering | Runs a bounded Codex review and fixer loop over uncommitted changes. | Claude Code/Cursor: `/codex-loop`; Codex: `$codex-loop` |

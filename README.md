...
| ----- | -------- | ------------ | ------ |
| [codex-loop](./skills/engineering/codex-loop/SKILL.md) | Engineering | Reviews staged changes with Codex, then verifies the unstaged fixes. | Claude Code/Cursor: `/codex-loop`; Codex: `$codex-loop` |
